...
//    private final AccessDeniedHandler accessDeniedHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        http
                ...
                .requestMatchers("/agent/auth/register").hasAuthority(Role.ADMIN.name())
                .requestMatchers(("/client/auth/register")).hasAnyAuthority(Role.ADMIN.name(),Role.AGENT.name())
                ...
                .requestMatchers("/agencies").hasAnyAuthority(Role.ADMIN.name())
